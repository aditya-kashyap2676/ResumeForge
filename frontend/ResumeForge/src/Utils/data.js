...
export const DUMMY_RESUME_DATA = {
    profileInfo: {
        ...
        summary:
            "Passionate and results-driven developer with 6+ years of experience building scalable web applications. Skilled in React, Node.js, and modern JavaScript technologies.",
    },
    contactInfo: {
    ...
    workExperience: [
        {
            ...
            endDate: "2025-04",
            description:
                "Leading the frontend team to build scalable enterprise applications using React. Improving application performance and maintaining reusable UI components.",
        },
        {
            company: "Coding Dev",
            ...
            endDate: "2022-02",
            description:
                "Worked in cross-functional teams developing full-stack solutions with React, Node.js, Express, and MongoDB. Built REST APIs and integrated frontend applications.",
        },
        {
            ...
            endDate: "2019-12",
            description:
                "Built responsive websites for startups and small businesses. Maintained legacy applications and improved user interfaces.",
        },
    ],
    education: [
        {
    ...
    projects: [
        {
            ...
            description:
                "A task and team management app built with MERN stack. Includes user roles, real-time updates, and task tracking.",
            github: "https://github.com/timetoprogram/project-manager-app",
        },
        {
            title: "E-Commerce Platform",
            description:
                "An e-commerce site built with Next.js and Stripe integration. Supports cart, checkout, and order management.",
            liveDemo: "https://ecommerce-demo.timetoprogram.com",
        },
        {
            title: "Blog CMS",
            description:
                "A custom CMS for blogging using Express and React. Includes WYSIWYG editor, user authentication, and post management.",
